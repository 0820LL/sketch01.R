        pdf(file="/PROJ/CR/Project/lb_sci_crq/beizhong-NSCLC/9_10_wbc.ca_20141004/lb/9/RL010009/02.Aln/Stat/RL010009_DLBC00026.cumuPlot.pdf",w=8,h=6)
        rt <- read.table("/PROJ/CR/Project/lb_sci_crq/beizhong-NSCLC/9_10_wbc.ca_20141004/lb/9/RL010009/02.Aln/Stat/RL010009_DLBC00026.cumu.xls",header=T)
        opar <- par()
        x <- rt$Depth[1:(600+1)]
        ...
        par(opar)
        dev.off()
        png(filename="/PROJ/CR/Project/lb_sci_crq/beizhong-NSCLC/9_10_wbc.ca_20141004/lb/9/RL010009/02.Aln/Stat/RL010009_DLBC00026.cumuPlot.png",width = 480, height = 360)
        par(mar=c(4.5, 4.5, 2.5, 2.5))
